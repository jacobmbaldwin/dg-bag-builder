...
const Navbar = () => {
      ...
      <List>
        <Link href="/">
          <Image
            ...
            src="/images/navbar/disc-loadout-logo_white.png"
            width={1851}
            height={565}
            alt="Disc Loadout"
          />
        ...
        {navLinks.map((navLink) => (
          <ListItem key={navLink.text} disablePadding>
            <ListItemButton>
              <ListItemIcon sx={{ color: "#fff" }}>{navLink.icon}</ListItemIcon>
        ...
        {userLinks.map((userLink) => (
          <ListItem key={userLink.text} disablePadding>
            <ListItemButton>
              ...
              <Link href={userLink.link}>
                <ListItemText primary={userLink.text} />
              </Link>
            </ListItemButton>
          </ListItem>
        ))}
  ...
  return (
    <nav>
      ...
      <Drawer
        variant={windowWidth <= 768 ? "temporary" : "permanent"}
        open={open}
